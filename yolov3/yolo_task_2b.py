...
log_path = os.path.join(".validation/video_logs",video_file_name.replace(".","csv"))

yolo3_detect_video_2a(video_path = complete_path, output_dir=output_path, log_path=log_path,score_threshold=0.32, iou_threshold=0.32,draw_roi=False, zoom=0.3,show_diver=True)
